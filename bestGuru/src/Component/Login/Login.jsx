  ...
  return (
    <>
      <section className="bg-gray-50 dark:bg-gray-900 h-screen" >
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-100 md:h-screen lg:py-0">
          <a href="#" className=" flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
            <img className=" mt-10 rounded-full bg-gray-50 dark:bg-gray-900 w-14 h-15 mr-2" src="public/portrait-boy-with-brown-hair-brown-eyes_1308-146018.avif" alt="logo" />
          ...
          <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="space-y-4 md:space-y-6" action="#">
                <div>
                  <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your name or email</label>
          ...
          <p className=" font-light text-gray-500 dark:text-gray-400">
              Please note that all content is subject to our policy, 
and all right recived</p>
          </div>
        </div>
      </section>
    </>
