              ...
              <form className="space-y-4 md:space-y-6" action="#">
                  ...
                  <div className="flex items-start">
                      ...
                      <div className="ml-3 text-sm">
                        <label  className="font-light text-gray-500 dark:text-gray-900">I accept the <a className="font-medium text-primary-600 hover:underline dark:text-primary-900" href="#">Terms and Conditions</a></label>
                      </div>
                  </div>
